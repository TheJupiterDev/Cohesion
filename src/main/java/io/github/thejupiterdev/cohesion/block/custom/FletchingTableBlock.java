...
public class FletchingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if(state.getBlock() != newState.getBlock()) {
            ...
            if(blockEntity instanceof FletchingTableBlockEntity fletchingTable) {
                fletchingTable.setStack(3, ItemStack.EMPTY);
                ItemScatterer.spawn(world, pos, fletchingTable);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntities.FLETCHING_TABLE_BE,
